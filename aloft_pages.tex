...
%Each regular balloon card is \emph{affiliated} with two of the five possible colors.  The colors that a balloon card is affiliated with are the colors of the envelope of the balloon depicted on that card. Special shape cards are not affiliated with any color.
  ...
  \item Place the truck cards in a single row below the four leftmost columns of the the game board.% These truck cards comprise the \emph{launch zone}. The leftmost truck card is called the \emph{last truck}. The rightmost truck card in the launch zone is called the \emph{lead truck}.
